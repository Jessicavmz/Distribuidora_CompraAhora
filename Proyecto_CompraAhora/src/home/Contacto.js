                ...
                <div class="row row-cols-1 row-cols-md-3 g-4">
                    <div class="col">
                        ...
                        <img src={asesor1} className="d-block w-100" alt="..."/>
                                <div className="card-body">
                                    <h5 className="card-title">Susana Jimenez</h5>
                                    <p className="card-text">Nuestra asesora de servicios brinda apoyo con los problemas o errores que la página puede presentar en el transcurso de tu compra online.</p>
                                </div>
                    ...
                    <div className="col">
                        ...
                        <img src={asesor2} className="d-block w-100" alt="..."/>
                                <div className="card-body">
                                    <h5 className="card-title">Paola Quiroz</h5>
                                    <p className="card-text">Nuestra asesora de call-center brinda apoyo en la primera compra online hasta realizar individualmente tu compra.</p>
                                </div>
                                <div className="card-footer">
                                <small className="text-body-secondary">Atención 24 horas</small>
                                </div>
